...
if [[ $prod == "APP" ]]; then
wget http://172.16.100.16:8085/browse/SCIM-AA$1M0$3-$4/artifact/shared/tar.gz/rebasoft-application-auditor-$2M0$3-$4.tar.gz  -P /opt/software/
pid=`cat /opt/Rebasoft/ApplicationAuditor/scimitar.pid`
kill -9 ${pid}
rm -rf /opt/Rebasoft/ApplicationAuditor
tar zxvf /opt/software/rebasoft-application-auditor-$2M0$3-$4.tar.gz -C /
