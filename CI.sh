...
if [[ $prod == "CORE" ]]; then
wget http://172.16.100.16:8085/browse/SAB-AC$1$3-$4/artifact/shared/tar.gz/rebasoft-auditor-core-$2$3$4-BUILD$5.tar.gz  -P /opt/software/
...
if [[ $prod == "APP" ]]; then
wget http://172.16.100.16:8085/browse/SCIM-AA$1$3-$4/artifact/shared/tar.gz/rebasoft-application-auditor-$2$3$4-$5.tar.gz  -P /opt/software/
